...
class StudentController extends Controller
{
    ...
    public function myCourse($course, $task, $quiz, $mid_term, $final) {
        ...
        return view("student/my_view", ['code'=>$this->code, 'name'=>$this->name, 'course'=>$this->course, 'task'=>$this->task, 'quiz'=>$this->quiz, 'mid_term'=>$this->mid_term, 'final'=>$this->final, 'grade'=>$this->grade]);
    }
